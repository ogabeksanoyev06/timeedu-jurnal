...
<template>
  <UIModal title="Telefon raqamini o'zgartirish" :model-value @update:model-value="emit('update:modelValue', $event)" body-class="lg:!max-w-[480px]">
    <div class="pt-4 p-5">
      <Transition name="fade" mode="out-in">
        <div class="flex flex-col gap-4" v-if="step === 1">
          <FormGroup label="Telefon raqami" for-id="phone">
            <FormPhone id="phone" v-model="form.phone" placeholder="Telefon raqami" type="email" />
          </FormGroup>

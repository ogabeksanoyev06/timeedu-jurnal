    ...
    <div class="lg:col-span-8">
      <div class="rounded-xl bg-gray-1 p-4 sm:p-6 md:p-8 lg:p-10 xl:p-14 h-full flex flex-col">
        ...
        <div class="mt-6 sm:mt-10 flex justify-end">
          <UIButton @click="navigateTo(journal.slug, 'about')" wrapper-class="bg-secondary hover:bg-secondary/90 max-sm:w-full" text="Batafsil" icon="icon-arrow-right-long-1 text-xl leading-5" />
        </div>
